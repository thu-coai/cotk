...
from .importer import import_object, get_module_members, get_object_members
...
from .custom_typing import stringify as stringify_typehint
from .custom_typing import stringify as stringify_annotation

if False:
    # For type annotation
    from typing import Type  # NOQA # for python3.5.1
    from .autodoc.directive import DocumenterBridge
...
def stringify_signature(sig: inspect.Signature, show_annotation: bool = True,
    ...
    if (sig.return_annotation == inspect.Signature.empty or
...
# This class is used only in ``autodoc.directive``,
...
from autodoc.mock import _MockImporter  # NOQA

deprecated_alias('autodoc',
                 {
