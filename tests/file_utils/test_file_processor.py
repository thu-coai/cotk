...
class TestFileUtils():
	...
	def test_OpenSubtitles_resource(self):
		...
		config_dir = str(pathlib.Path('./tests/file_utils/dummy_coai'))
		data_dir = str(pathlib.Path('./tests/file_utils/data'))
		res_path = get_resource_file_path(str(pathlib.Path('./tests/file_utils/data/opensubtitles.zip#OpenSubtitles')), cache_dir, config_dir)
		assert os.path.isdir(res_path)
	...
	def test_Ubuntu_resource(self):
		...
		config_dir = str(pathlib.Path('./tests/file_utils/dummy_coai'))
		data_dir = str(pathlib.Path('./tests/file_utils/data'))
		res_path = get_resource_file_path(str(pathlib.Path('./tests/file_utils/data/ubuntu_dataset.zip#Ubuntu')), cache_dir, config_dir)
		assert os.path.isdir(res_path)
