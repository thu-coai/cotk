...
class LanguageGeneration(Dataloader):
    ...
    def get_teacher_forcing_metric(self, gen_prob_key="gen_prob"):
        ...
        * :class:`.metric.PerlplexityMetric`
        ...
        '''
        return PerlplexityMetric(self, data_key='sentence', data_len_key='sentence_length', gen_prob_key=gen_prob_key)
    ...
    def get_inference_metric(self, gen_key="gen"):
        ...
        * :class:`.metric.BleuCorpusMetric`
        ...
        metric.add_metric(LanguageGenerationRecorder(self, sentence_key="sentence", gen_key=gen_key))
        return metric
