	...
	def forward(self, data):
		...
		Arguments:
			...
			data[reference_allvocabs_key] (list of list of list): Reference sentences.
				...
				Size: `[batch_size, ~sentence_num, ~word_num]`, which "~" means different sizes allowed.
				Examples:
					>>> data[reference_allvocabs_key] = [[[1],[2,3]],[[4,5],[6],[7]]]
			data[gen_key] (list of list of list): Sentence generations model outputs
...
class SelfBleuCorpusMetric(MetricBase):
	...
	Arguments:
		...
		seed (int): random seed for sampline.
	'''
	def __init__(self, dataloader, \
		gen_key="gen", \
		sample=1000, \
	...
	def run_f(self, ele):
		'''Auxiliary function which returns:
			* **sentence-bleu**: sentence-bleu value.
		'''
